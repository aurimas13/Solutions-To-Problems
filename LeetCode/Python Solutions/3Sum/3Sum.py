...
class Solution:
    def threeSum(self, nums: List[int]) -> List[List[int]]:
        ...
        res, dups = set(), set()
        # Enumerating nums list and searching for all values of it that sum.py to 0
        for i, val1 in enumerate(nums):
            ...
            if val1 not in dups:
				...
				# and if it does it means we can have triplets that sum.py to zero
				# and add this to res set as a possible solution
				# return the tuple of values that sum.py to zero
