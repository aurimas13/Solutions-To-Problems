The problem description of "Rising Temperature" is found [here](https://leetcode.com/problems/rising-temperature/description/) while the solution is found [here]().
